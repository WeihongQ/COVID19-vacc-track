...
// get the realname
$realname = get_teacher_realname($id);
?>
...
<body class="text-center">
    <main class="w-100 m-auto">
        <div style="max-width: 1260px; margin: auto">
            ...
            if (isset($_GET['message'])) {
                ...
                if ($message == "edit_success") {
                    ...
                    echo "<div class='alert alert-success' id='successAlert' style='position:fixed;top:10px;left:0px;right:0px' role='alert'>
                        <strong>Success!</strong> Grade report has been updated.
                    </div>";
                }
            }
            ?>
            <div class="titleBar" style="text-align: left">
                ...
                <p>Select the student grade you want to edit from above.</p>
    ...
    <script>
        var studentList = <?php echo get_students_by_teacher($id) ?>;
        ...
        function renderStudentList() {
            ...
            studentList.forEach(function(item) {
                ...
                button.onclick = function() {
                    window.location.href = "https://summer2022csc261.herokuapp.com/edit/grade.php?id=" + item.studentID;
                };
